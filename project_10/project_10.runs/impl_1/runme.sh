...
HD_PWD='E:/Documents/digital-logic/project_10/project_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exp_11.tcl -notrace
