...
HD_PWD='E:/Documents/digital-logic/project_10/project_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exp_11.tcl
