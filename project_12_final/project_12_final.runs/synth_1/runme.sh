...
HD_PWD='E:/Documents/digital-logic/project_12_final/project_12_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dataShift8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dataShift8.tcl
