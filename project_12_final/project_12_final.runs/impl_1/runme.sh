...
HD_PWD='E:/Documents/digital-logic/project_12_final/project_12_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dataShift8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dataShift8.tcl -notrace
